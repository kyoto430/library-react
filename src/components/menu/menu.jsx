...
import arrowUp from '../../assets/images/main/menu/arrowUp.png'
import arrowDown from '../../assets/images/main/menu/arrowDown.png'
  ...
  return (
    <section className={styles.menu}>
      <details open={active}>
        <summary>
          <NavLink
            to="/books"
            className={(navData) =>
              navData.isActive ? styles.booksAllLinkActive : ''
            }
          >
            <h2 onClick={handleToggleMenu} className={styles.menuListTitle}>
              Витрина книг{' '}
              {active && active ? (
        ...
        <ul className={styles.menuList}>
          <li>
            <NavLink
              to="/books/all"
              className={(navData) =>
                navData.isActive ? styles.menuLinkActive : ''
              }
            >
              <span>Все книги</span>{' '}
            </NavLink>
      ...
      <NavLink
        ...
        to="/terms"
        className={(navData) =>
          navData.isActive ? styles.termsLinkActive : ''
        }
      >
